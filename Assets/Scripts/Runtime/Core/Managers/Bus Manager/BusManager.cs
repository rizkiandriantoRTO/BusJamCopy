...
public class BusManager : MonoBehaviour
{
    ...
    public void CreateBus()
    {
        ...
        bus.GetComponent<Character>().ColorType = ColorType;
        bus.GetComponent<MaterialCharacterController>().SetCharacterMaterial(GetMaterialAccordingToColorType(ColorType));
