...
public class GridCreator : MonoBehaviour
{
    ...
    {
        GridParts = new Grid[RowCount, ColumnCount];
    ...
    {
        var gridParts = FindObjectsOfType<Grid>();
        for (int i = 0; i < RandomCharacterCount; i++)
        {
            var emptyGridParts = gridParts.Where(x => x.InsideCharacter == null).ToList();
